...
The CLI utilizes an advanced Python framework for a dynamic and user-friendly output.<br />
When output is redirected, we use the JSON format for its ease of data handling.
