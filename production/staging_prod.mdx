...
## Setup
Staging workspaces can be set up through: [app.staging.airfold.co](https://app.staging.airfold.co/)

Production workspaces can be set up through: [app.airfold.co](https://app.airfold.co/)
