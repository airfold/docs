...
In this guide, we will use Airfold's three core concepts: **Ingest**, **Transform**, and **Publish**.
...
If this is your first time using Airfold, you will be directed to our welcome page where you can simply type in a name:
...
Then, name it `web_events_sample_csv`, and make sure to select the checkbox `ingest data` before clicking on "Create source."
