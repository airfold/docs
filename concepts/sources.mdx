...
<ResponseField name="type" type="string">
  Type of source: `Table` or `AITable`, see more on [AI
  table](/concepts/ai_tables) (Optional)
</ResponseField>
...
<ResponseField name="cols" type="{name: type}" required>
  ...
  Types](https://clickhouse.com/docs/en/sql-reference/data-types))
</ResponseField>
<ResponseField name="settings" type="string | {key: value} | array">
  [ClickHouse table
  configuration](https://clickhouse.com/docs/en/sql-reference/statements/create/table)
