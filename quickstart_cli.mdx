...
## Create a [Workspace](/cli/workspaces)
...
## Further Analysis with [Pipes](/cli/pipes)
...
Explore [workspaces](/cli/workspaces), [sources](/cli/sources), and [pipes](/cli/pipes) to learn more about how to interact with Airfold.
Our the [API](/api-reference) and [CLI](/cli/cli_reference) documentation is also available for further information.
