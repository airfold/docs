...
Now, click on "Create" > hover over the column name > <Icon icon="play" iconType="solid" />  > "All rows"
...
Explore [workspaces](/workspace/workspaces), [sources](/workspace/sources), and [pipes](/workspace/pipes) to learn more about how to interact with Airfold.
