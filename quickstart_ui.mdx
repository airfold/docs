...
## Create a [Workspace](/ui/workspaces)
...
Check out how to do this through the CLI through [Quickstart (CLI)](/quickstart_cli).

Explore [workspaces](/ui/workspaces), [sources](/ui/sources), and [queries](/ui/queries) to learn more about how to interact with Airfold.
