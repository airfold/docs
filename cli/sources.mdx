...
<ResponseField name="type" type="string">
  Type of source: `Table` or `AITable`, see more on [AI table](/cli/ai_tables)
</ResponseField>
...
## Push
Push sources to your [workspace](/workspace/workspaces) using the [CLI command](/cli/cli_reference) or [API](/api-reference/workspace/push).<br />
