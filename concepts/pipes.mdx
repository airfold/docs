...
This page dives deeper into the structure and usage of individual pipes. For an introduction to how pipes are composed into pipelines, see [pipelines](/query/pipelines).
...
=======
#### Creating Incremental Materialized pipe
>>>>>>> 32d0dd5fa4bb586319f63cf1b734532b92267b5c
...
```bash published_pipe
af push published_pipe.yaml
```

```bash incremental_pipe
af push incremental_pipe.yaml
```

```bash refreshable_pipe
af push refreshable_pipe.yaml
```
</CodeGroup>
